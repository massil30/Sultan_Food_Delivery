...
class AppColors {
  ...
  static const Color lightPrimary = Color(0xFFF9A800);            // primary (YELLOW instead of red)
  static const Color lightSecondary = Color(0xFF2D2C2F);          // secondary (dark gray/black)
